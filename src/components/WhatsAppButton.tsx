...
const WhatsAppButton: React.FC = () => {
  const handleWhatsAppClick = () => {
    ...
    const message = encodeURIComponent('Hi! I\'m interested in Authentic Cultural Experiences in Kashmir in Kashmir that create genuine connections with local communities. Can you help me find my perfect cultural immersion journey?');
